...
const index = require("./index-jxNu7Wqb.js");
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", gap: 2, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          index.SingleSelect,
          {
            ...
            children: lodashExports.range(1, 21).map((deepness) => /* @__PURE__ */ jsxRuntime.jsx(index.SingleSelectOption, { value: deepness.toString(), children: deepness }, deepness))
          }
        )
      ] })
    ] }) })
...
const About = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.Box, { style: { alignSelf: "stretch" }, background: "neutral0", padding: 8, marginTop: 6, hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 6, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(index.Box, { children: /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 2, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "row", gap: 4, children: [
          /* @__PURE__ */ jsxRuntime.jsx(index.Link, { href: "https://github.com/Prototypr/strapi-import-export", isExternal: true, children: "GitHub (Strapi 5)" }),
          /* @__PURE__ */ jsxRuntime.jsx(index.Link, { href: "https://x.com/graeme_fulton", isExternal: true, children: "Converted by Graeme" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 2, marginTop: 4, children: [
        /* @__PURE__ */ jsxRuntime.jsx(index.Typography, { variant: "delta", children: "Original Work" }),
        /* @__PURE__ */ jsxRuntime.jsx(index.Typography, { children: i18n({
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntime.jsx(index.Link, { href: "https://strapi-import-export-entries.canny.io", isExternal: true, children: i18n({
            id: "plugin.page.about.need-help.product-roadmap",
            defaultMessage: "Product Roadmap"
          }) }),
          /* @__PURE__ */ jsxRuntime.jsx(index.Link, { href: "https://discord.gg/dcqCAFFdP8", isExternal: true, children: i18n({
            id: "plugin.page.about.need-help.discord",
            defaultMessage: "Discord"
          }) }),
          /* @__PURE__ */ jsxRuntime.jsx(index.Link, { href: "https://github.com/Baboo7/strapi-plugin-import-export-entries/issues", isExternal: true, children: i18n({
        ...
        index.Box,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { direction: "column", alignItems: "start", gap: 6, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(index.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(index.Flex, { direction: "column", alignItems: "start", gap: 4, children: /* @__PURE__ */ jsxRuntime.jsxs(index.Flex, { gap: 4, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(index.ExportModal, { availableExportFormats: [index.dataFormats.JSON_V2] })
            ] }) }) })
          ] })
        }
      ),
...
exports.App = App;
//# sourceMappingURL=App-CzzFYy8C.js.map
